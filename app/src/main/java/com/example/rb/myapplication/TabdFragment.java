...
public class TabdFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    Typeface tf;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) { return inflater.inflate(R.layout.fragment_tabd, null);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        this.getActivity().getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
         tf = Typeface.createFromAsset(this.getActivity().getAssets(), "IRANSansMobile(FaNum).ttf");
                ...
                public void onTopRecieve(int status, String message, int[]levels, int[]scores, String[]names, int corrects[], int golds[], int[]avatars, String phones[]){
                    if (status==0){
                        ...
                        for(int i=0;i<ncount;i++){
                            ...
                            score.setText(String.valueOf(golds[i]));
