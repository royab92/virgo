...
/*    public static Fragment getInstance(int position) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) { return inflater.inflate(R.layout.fragment_tab, null);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
     ...
     final SharedPreferences pref = getContext().getSharedPreferences("VorujakPref", MODE_PRIVATE);
        ...
        try {
            ...
            requestjo.put("type", "correctAnswer");
                ...
                public void onTopRecieve(int status, String message, int[] levels, int[] scores, String[] names, int corrects[], int golds[], int[] avatars, String phones[]) {
                    if (status == 0) {
                        ...
                        for (int i = 0; i < ncount; i++) {
                            ...
                            info3.widthPercent = 0.10f;
                            smar = smar + 0.15f;
                            info3.startMarginPercent = 0.15f;
                            score.setTypeface(tf);
                            score.setText(String.valueOf(corrects[i]));
...
// ViewPagerAdapter mViewPager=new ViewPagerAdapter(getFragmentManager());;
//  View view = View.inflate(this.getActivity(), R.layout.fragment_dana, null);
//  mViewPager =(ViewPager) view.findViewById(R.id.viewpager);
// String tag = getFragmentManager().getBackStackEntryAt(getFragmentManager().getBackStackEntryCount() - 1).getName();
//  Fragment currentFragment = getFragmentManager().findFragmentByTag(fragment.getClass().getName());
//  if(fragment!=null){