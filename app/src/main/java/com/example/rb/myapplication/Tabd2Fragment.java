...
public class Tabd2Fragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    Typeface tf;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) { return inflater.inflate(R.layout.fragment_tabd2, null);
    }
